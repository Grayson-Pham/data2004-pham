...
population_csv<- read_csv("data/raw/API_SP.POP.TOTL_DS2_en_csv_v2_285942.csv", skip = 4)
...
population_xls<-read_xls("data/raw/API_SP.POP.TOTL_DS2_en_excel_v2_290931.xls",
                         sheet = "Data", skip = 3)
